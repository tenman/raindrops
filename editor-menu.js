...
var test_layout = '<div class="yui-gd"><div class="yui-u first gradient3" style="min-height:150px"><div>left narrow</div></div><div class="yui-u gradient-3" style="min-height:150px"><div>right main</div></div></div>';

var harf = '<div class="yui-g"><div class="yui-u first gradient-3" style="min-height:100px;"><div>Left Column</div></div><div class="yui-u gradient-3" style="min-height:100px;"><div>Right Column</div></div></div>';
...
var dialog = '<div class="gradient-3 raindrops-dialog" style="min-height: 100px;"><h2 class="gradient-2 raindrops-dialog-title" style="margin: 0; padding: 0.2em 1em;">title</h2><div class="raindrops-dialog-content" style="padding: 1em;">text</div></div>';
