...
class tmn_menu_create {
    ...
    var $col_settings_raindrops_col_width = array("left 160px"=>"t1","left 180px"=>"t2","left 300px"=>"t3","right 180px"=>"t4","right 240px"=>"t5","right 300px"=>"t6");

    var $col_settings_raindrops_page_width = array("750px centered"=>"doc","950px centered"=>"doc2","100% fluid"=>"doc3","974px fluid"=>"doc4");

    var $col_settings_raindrops_right_sidebar_width_percent = array("25%"=>"25","33%"=>"33","50%"=>"50","66%"=>"66","75%"=>"75");

    var $col_settings_raindrops_show_right_sidebar = array("show"=>"show","hide"=>"hide");

    var $col_settings_raindrops_style_type = array("light"=>"light","dark"=>"dark","default"=>"default");
    ...
    function SubMenu_GUI() {
        ...
        $result .= '<div id="icon-options-general" class="icon32"><br></div>';
        $result .= '<h2 class="h2">Raindrops theme Settings</h2>';
    ...
    function form_user_input(){
        ...
        $lines .= $table;
            ...
            if( $result->option_name == "raindrops_base_color" or
                ...
                $lines .= "<td>".$this->color_selector('option_value',$result->option_value,$i)."</td>";
                ...
                $lines .= '<td>';
                $lines .= sprintf($this->line_select_element,$this->accesskey[$i],"option_value",4,80);
                ...
                $lines .= '<td>';
                $lines .= sprintf($this->line_select_element,$this->accesskey[$i],"option_value",5,100);
                ...
                $lines .= '<td>';
                $lines .= sprintf($this->line_select_element,$this->accesskey[$i],"option_value",2,40);
                ...
                $lines .= '<input  accesskey="'.$this->accesskey[$i].'" type="text" name="option_value" value="'.$result->option_value.'"';
