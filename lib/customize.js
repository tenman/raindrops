    ...
    */}).toString().match(/[^]*\/\*([^]*)\*\/\}$/)[1];    
    ...
    $( document ).on( 'change', function(event) {
        ...
        if ( wp.customize.instance( 'raindrops_theme_settings[raindrops_style_type]' ).get() == 'dark' ) {
            ...
            wp.customize.instance( 'header_textcolor' ).set(  raindrops_customizer_script_vars.dark_header_textcolor );
            ...
            wp.customize.instance( 'header_textcolor' ).set( raindrops_customizer_script_vars.w3standard_header_textcolor );
            ...
            wp.customize.instance( 'header_textcolor' ).set( raindrops_customizer_script_vars.light_header_textcolor );
