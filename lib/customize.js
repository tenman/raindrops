(function($){
	...
	$(window).resize(function(){
        ...
        $( '#raindrops-customizer-label' ).before( '<span class="raindrops-theme-settings-presentation link"><a href="'+ raindrops_customizer_script_vars.home_url +'/wp-admin/customize.php?autofocus[section]=raindrops_theme_settings_presentation">'+ raindrops_customizer_script_vars.basic_config_label +'</a></span>');
