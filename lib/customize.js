(function($){
    var $output = (function(){/*
        <div id="raindrops-customizer-preview-menu" class="wp-ui-primary">
            <span id="raindrops-customizer-label2"></span>
...
console.log($('iframe').contents());
    ...
    //$( '#raindrops-customizer-label2' ).before( '<span class="raindrops-theme-settings-presentation link" ><a href="https://tenman.info/" class="wp-ui-primary" target="_blank">edit</a></span>');
...
(function($){
    ...
    */
    ...
    /* blog description */
        ...
        wp.customize( 'raindrops_show_related_posts', function( value ) {
            value.bind( function( to ) {
                    $( '.related-posts' ).html( to );
            } );
        } );
    ...
    api.section( 'static_front_page', function( section ) {
        section.expanded.bind( function( isExpanded ) {
            ...
            if ( isExpanded ) {
                ...
                console.log(  api.previewer.previewUrl );
