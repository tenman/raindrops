    ...
    */}).toString().match(/[^]*\/\*([^]*)\*\/\}$/)[1];
    ...
    $( document ).on( 'change', function(event) {
       ...
       if( 'option' == raindrops_customizer_script_vars.setting_field_type ) {
            ...
            if ( wp.customize.instance( 'raindrops_theme_settings[raindrops_style_type]' ).get() == 'dark' && 'dark' !== raindrops_customizer_script_vars.raindrops_current_style_type ) {
            ...
            } else if ( wp.customize.instance( 'raindrops_theme_settings[raindrops_style_type]' ).get() == 'w3standard' && 'w3standard' !== raindrops_customizer_script_vars.raindrops_current_style_type) {
            ...
            } else if ( wp.customize.instance( 'raindrops_theme_settings[raindrops_style_type]' ).get() == 'light' && 'light' !== raindrops_customizer_script_vars.raindrops_current_style_type) {
            ...
            } else if ( wp.customize.instance( 'raindrops_theme_settings[raindrops_style_type]' ).get() == 'minimal' && 'minimal' !== raindrops_customizer_script_vars.raindrops_current_style_type) {
