    ...
    */}).toString().match(/[^]*\/\*([^]*)\*\/\}$/)[1];
    ...
    $( document ).on( 'change', function(event) {
       ...
       if( 'option' == raindrops_customizer_script_vars.setting_field_type ) {
            ...
            if ( ( wp.customize.instance( 'raindrops_theme_settings[raindrops_style_type]' ).get() == 'dark' && 'dark' !== raindrops_customizer_script_vars.raindrops_current_style_type ) || ( wp.customize.instance( 'raindrops_theme_settings[raindrops_style_type]' ).get() == 'dark' && 'no' == raindrops_customizer_script_vars.is_customized) ) {
             ...
             // @1.321  wp.customize.instance( 'header_textcolor' ).set(  raindrops_customizer_script_vars.dark_header_textcolor );
            } else if ( wp.customize.instance( 'raindrops_theme_settings[raindrops_style_type]' ).get() == 'w3standard' && 'w3standard' !== raindrops_customizer_script_vars.raindrops_current_style_type || ( wp.customize.instance( 'raindrops_theme_settings[raindrops_style_type]' ).get() == 'w3standardk' && 'no' == raindrops_customizer_script_vars.is_customized) ) {
             ...
             //  @1.321  wp.customize.instance( 'header_textcolor' ).set( raindrops_customizer_script_vars.w3standard_header_textcolor );
            } else if ( wp.customize.instance( 'raindrops_theme_settings[raindrops_style_type]' ).get() == 'light' && 'light' !== raindrops_customizer_script_vars.raindrops_current_style_type || ( wp.customize.instance( 'raindrops_theme_settings[raindrops_style_type]' ).get() == 'light' && 'no' == raindrops_customizer_script_vars.is_customized) ) {
              ...
              // @1.321  wp.customize.instance( 'header_textcolor' ).set( raindrops_customizer_script_vars.light_header_textcolor );
            } else if ( wp.customize.instance( 'raindrops_theme_settings[raindrops_style_type]' ).get() == 'minimal' && 'minimal' !== raindrops_customizer_script_vars.raindrops_current_style_type || ( wp.customize.instance( 'raindrops_theme_settings[raindrops_style_type]' ).get() == 'minimal' && 'no' == raindrops_customizer_script_vars.is_customized) ) {
                ...
                if (  raindrops_customizer_script_vars.is_customized == 'no' ) {

                    wp.customize.instance( 'raindrops_theme_settings[raindrops_show_right_sidebar]' ).set( 'hide' );
                    wp.customize.instance( 'raindrops_theme_settings[raindrops_col_width]' ).set( 't6' );
                }

              // @1.321 wp.customize.instance( 'header_textcolor' ).set( raindrops_customizer_script_vars.minimal_header_textcolor );
            } else {
              ...
              //  wp.customize.instance( 'header_textcolor' ).set( raindrops_customizer_script_vars.minimal_header_textcolor );
            }
