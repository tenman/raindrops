...
////////////////////////////////////////////////
		...
		'raindrops_text_transform_of_title'					 => array( 'option_id'		 => 116,
			...
			'list'			 => 115 ),
		'raindrops_show_relate_posts'					 => array( 'option_id'		 => 117,
			'blog_id'		 => 0,
			'option_name'	 => 'raindrops_show_relate_posts',
			'option_value'	 => 'yes',
			'autoload'		 => 'yes',
			...
			'validate'		 => 'raindrops_show_relate_posts_validate',
			'list'			 => 116 ),
		'raindrops_show_relate_posts_type'					 => array( 'option_id'		 => 117,
			'blog_id'		 => 0,
			'option_name'	 => 'raindrops_show_relate_posts_type',
			'option_value'	 => 'automatic',
			'autoload'		 => 'yes',
			...
			'validate'		 => 'raindrops_show_relate_posts_type_validate',
			'list'			 => 116 ),
		'raindrops_show_relate_posts_orderby'					 => array( 'option_id'		 => 118,
			'blog_id'		 => 0,
			'option_name'	 => 'raindrops_show_relate_posts_orderby',
			...
			'validate'		 => 'raindrops_show_relate_posts_orderby_validate',
			'list'			 => 117 ),
		'raindrops_show_relate_posts_count'					 => array( 'option_id'		 => 119,
			'blog_id'		 => 0,
			'option_name'	 => 'raindrops_show_relate_posts_count',
			'option_value'	 => 2,
			'autoload'		 => 'yes',
			'title'			 => esc_html__( 'Counts of post', 'raindrops' ),
			'excerpt1'		 => '',
			'excerpt2'		 => esc_html__( 'Please specify the number of display. default 4', 'raindrops' ),
			'validate'		 => 'raindrops_show_relate_posts_count_validate',
			'list'			 => 118 ),
		'raindrops_show_relate_posts_line_clip'					 => array( 'option_id'		 =>120,
			'blog_id'		 => 0,
			'option_name'	 => 'raindrops_show_relate_posts_line_clip',
			'option_value'	 => 'no',
			'autoload'		 => 'yes',
			'title'			 => esc_html__( 'Maximum row number of title,if you need', 'raindrops' ),
			'excerpt1'		 => '',
			'excerpt2'		 => esc_html__( 'default no', 'raindrops' ),
			'validate'		 => 'raindrops_show_relate_posts_line_clip_validate',
			'list'			 => 119 ),
		'raindrops_show_relate_posts_title'					 => array( 'option_id'		 =>121,
			'blog_id'		 => 0,
			'option_name'	 => 'raindrops_show_relate_posts_title',
			'option_value'	 => esc_html__( 'Relate Posts', 'raindrops' ),
			'autoload'		 => 'yes',
			'title'			 => esc_html__( 'Counts of post', 'raindrops' ),
			'excerpt1'		 => '',
			'excerpt2'		 => esc_html__( 'Please specify the number of display', 'raindrops' ),
			'validate'		 => 'raindrops_show_relate_posts_title_validate',
			'list'			 => 120 ),
		'raindrops_show_relate_posts_excerpt_length'					 => array( 'option_id'		 =>122,
			'blog_id'		 => 0,
			'option_name'	 => 'raindrops_show_relate_posts_excerpt_length',
			'option_value'	 => 100,
			'autoload'		 => 'yes',
			'title'			 => esc_html__( 'Excerpt length of Relate Posts', 'raindrops' ),
			'excerpt1'		 => '',
			'excerpt2'		 => esc_html__( 'Please specify the number of excerpt length. use string length , not word count. default 100', 'raindrops' ),
			'validate'		 => 'raindrops_show_relate_posts_excerpt_length_validate',
			'list'			 => 121 ),
		'raindrops_show_relate_posts_thumbnail'					 => array( 'option_id'		 =>122,
			'blog_id'		 => 0,
			'option_name'	 => 'raindrops_show_relate_posts_thumbnail',
			'option_value'	 => 'show',
			'autoload'		 => 'yes',
			'title'			 => esc_html__( 'Featured Image', 'raindrops' ),
			'excerpt1'		 => '',
			'excerpt2'		 => esc_html__( 'Please specify the number of excerpt length. use string length , not word count. default 100', 'raindrops' ),
			'validate'		 => 'raindrops_show_relate_posts_thumbnail_validate',
			'list'			 => 121 ),
		'raindrops_show_relate_posts_thumbnail_fallback'					 => array( 'option_id'		 =>123,
			'blog_id'		 => 0,
			'option_name'	 => 'raindrops_show_relate_posts_thumbnail_fallback',
			...
			'validate'		 => 'raindrops_show_relate_posts_thumbnail_fallback_validate',
			'list'			 => 122 ),
	);
}
